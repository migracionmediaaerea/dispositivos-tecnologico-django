...
LOG_FILE_TOGGLE = os.getenv('LOG_FILE')
...
MIDDLEWARE = [
    ...
    'apps.comun.error_handler.PermissionDeniedErrorHandler',
...
LOGIN_REDIRECT_URL = 'dispositivos:index'
...
DJANGO_INTERNO = os.getenv('DJANGO_INTERNO', 'http://localhost:8001')

ACCESO_URL = os.getenv('ACCESO_URL', 'http://localhost:8001')
...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER_INTERNO')
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD_INTERNO')
